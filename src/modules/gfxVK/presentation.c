...
void presentation_record_commands(void) {
    ...
    for (i = 0; i < count; ++i) {
        ...
        vkCmdPushConstants(_command_buffers[_current_frame], meshes[i]->shader->p_layout, VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT, 0, 64, meshes[i]->push);
